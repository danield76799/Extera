...
abstract class L10n {
  ...
  /// No description provided for @noSendPermission.
  ///
  ...
  /// No description provided for @translatedMessage.
  ///
  /// In en, this message translates to:
  /// **'Translated message'**
  String get translatedMessage;

  /// No description provided for @errorTranslatingMessage.
  ///
  /// In en, this message translates to:
  /// **'An error has occured while translating the message.'**
  String get errorTranslatingMessage;

  /// No description provided for @recoverMessage.
  ///
  /// In en, this message translates to:
  /// **'Recover message'**
  String get recoverMessage;

  /// No description provided for @recoveredMessage.
  ///
  /// In en, this message translates to:
  /// **'Recovered message'**
  String get recoveredMessage;

  /// No description provided for @errorRecoveringMessage.
  ///
  /// In en, this message translates to:
  /// **'An error has occured while recovering the message.'**
  String get errorRecoveringMessage;

  /// No description provided for @errorRecoveringMessageNoAdmin.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @hideAvatarsInInvites.
  ///
  /// In en, this message translates to:
  /// **'Hide avatars in invites'**
  String get hideAvatarsInInvites;

  /// No description provided for @hideAvatarsInInvitesDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @pureBlackToggle.
  ///
  /// In en, this message translates to:
  /// **'Pure Black'**
  String get pureBlackToggle;
  ...
  ///
  /// In en, this message translates to:
  /// **'You are sharing your screen in Extera'**
