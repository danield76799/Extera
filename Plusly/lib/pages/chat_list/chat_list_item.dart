...
class ChatListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bridgeInfo = getBridgeTypeInfo(bridgeType);
                        ...
                        if (bridgeType != null)
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: Icon(
                                bridgeInfo?.icon ?? Icons.link,
                                size: 12,
                                color: bridgeInfo?.color ?? Colors.grey,
                              ),
                            ),
                          ),
                      ],
                            ...
                            future: needLastEventSender
                                ? lastEvent.calcLocalizedBody(
                                    ...
                                    withSenderNamePrefix:
                                        ...
                                        bridgeType == null, // Hide prefix if bridge icon shown
                                  )
                                : null,
